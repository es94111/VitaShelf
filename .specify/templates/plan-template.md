...
依據 `.specify/memory/constitution.md` v1.0.0 衍生的閘門：

- [ ] **I. 繁體中文文件**：本 plan、spec、tasks、quickstart、research 等輸出皆以繁體中文（zh-TW）撰寫。
- [ ] **II. OpenAPI 3.2 合約優先**：若涉及 HTTP/REST 變更，`contracts/` 下規劃了 OpenAPI **3.2** 規格檔；endpoint 實作不會先於規格合併。
