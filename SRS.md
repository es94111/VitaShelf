...
| 註冊 | `/register` | 使用者註冊頁面 |
| 儀表板 | `/` | 總覽儀表板 |
| 產品列表 | `/products` | 所有產品的列表 |
| 產品詳情 | `/products/:id` | 單一產品的完整資訊 |
| 新增產品 | `/products/new` | 新增產品表單 |
| 購買紀錄 | `/purchases` | 所有購買紀錄 |
| 到期提醒 | `/alerts` | 到期 / 低庫存提醒 |
| 分類管理 | `/categories` | 管理分類與標籤 |
| 設定 | `/settings` | 使用者偏好設定 |
...
| 階段 | 版本 | 內容 | 預計狀態 |
|------|------|------|----------|
| Phase 1 | v0.1.0 | 專案初始化、SRS 文件、CI/CD 骨架 | ✅ 完成 |
| v0.2.0  | —      | JWT Secret 自動亂數產生機制 | ✅ 完成 |
| Phase 2 | v0.3.0 | 後端 API 完善 + 前端產品 CRUD 完整 UI | ✅ 當前 |
| Phase 3 | v0.4.0 | 購買紀錄 CRUD 前端 UI | 🔲 待開發 |
| Phase 4 | v0.4.0 | 購買紀錄 + 有效期限管理 | 🔲 待開發 |
| Phase 5 | v0.5.0 | 庫存管理 + 到期提醒 | 🔲 待開發 |
| Phase 6 | v0.6.0 | 儀表板 + 統計圖表 | 🔲 待開發 |
| Phase 7 | v0.7.0 | 使用者管理 + 權限 | 🔲 待開發 |
| Phase 8 | v0.8.0 | 匯出入功能 | 🔲 待開發 |
| Phase 9 | v0.9.0 | Docker 部署優化 + 測試 | 🔲 待開發 |
| Phase 10 | v1.0.0 | 正式發佈 | 🔲 待開發 |
